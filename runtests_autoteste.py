...
class TestStringMethods(unittest.TestCase):
    ...
    '''
    Se tentarmos adicionar a mesma alternativa mais de uma vez,
    isso não altera a lista de alternativas
    '''
    ...
    e devo tomar um cod status 404
    '''
    ...
    '''
    usando put na url /autoteste/questao/1/corretas,
    adiciono alternativas corretas para questao 1
    '''
    ...
    isso não altera a lista de alternativas
    '''
    def test_009b_adiciona_alternativas_corretas_repetidas(self):
        r = requests.post(url+'reseta')
        self.assertEqual(r.status_code,200)
    ...
    ''' 
    se o usuário tentar responder uma questão que não existe, deve receber um erro
    '''
    ...
    '''
    verificação de id crescente, em principio
    se você fez tudo certo, esse teste é de graça
    '''
    ...
    '''
    verificação de id sem repetição, em principio
    se você fez tudo certo, esse teste é de graça
    '''
